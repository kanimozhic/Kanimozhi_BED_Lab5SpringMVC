package com.kanimozhi.greatlearning.EmployeeManagementSystem.controller;
...
import com.kanimozhi.greatlearning.EmployeeManagementSystem.service.EmployeeService;
...
public class EmployeeController {
	...
	public String listEmployees(Model model) {
		// model.addAttribute("message","Hello this is sent from java code from
		// controller");
